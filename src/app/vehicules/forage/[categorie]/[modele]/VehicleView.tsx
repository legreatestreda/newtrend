  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[70vh] overflow-hidden">
        {data.gallery[activePhoto] && (
          <Image
            src={data.gallery[activePhoto]}
            alt={data.name}
            fill
            ...
            <div className="mt-14">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {data.similar.map(vehicle => (
                  <Link
                    key={vehicle.slug}
                    href={`/vehicules/forage/${vehicle.category}/${vehicle.slug}`}
                    className="
